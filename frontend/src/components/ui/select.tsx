...
>(({ className, error, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-9 w-full items-center justify-between rounded-lg border bg-white px-3 py-2 text-sm text-slate-900 shadow-sm transition-colors',
      ...
      'aria-invalid:focus:ring-red-400 aria-invalid:border-red-400',
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      'data-[highlighted]:outline-none data-[highlighted]:bg-slate-100',
      className
    )}
    {...props}
  >
